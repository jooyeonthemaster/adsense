    ...
    <div className="container mx-auto p-3 sm:p-4 lg:p-6">
      <div className="space-y-6">
          ...
          <div className="flex items-center justify-between">
            <div>
              <div className="flex items-center gap-3 mb-2">
                ...
                <h1 className="text-2xl font-bold">체험단 마케팅 접수 현황</h1>
              </div>
              <p className="text-violet-100">블로거/인플루언서 체험단 접수 내역을 관리하세요</p>
            </div>
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
          ...
          <div className="p-4 rounded-lg border border-violet-200 bg-violet-50 shadow-sm">
            <p className="text-xs text-violet-600 mb-1">진행중</p>
            <p className="text-2xl font-bold text-violet-900">{stats.in_progress}</p>
          </div>
          ...
          <div className="p-4 rounded-lg border border-violet-200 bg-violet-50 shadow-sm">
            <p className="text-xs text-violet-600 mb-1">총 비용</p>
            <p className="text-2xl font-bold text-violet-900">{stats.total_cost.toLocaleString()}P</p>
          </div>
        </div>
              ...
              return (
                <div key={sub.id} className="bg-white border rounded-lg p-4 space-y-3 shadow-sm">
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <span className="text-sm text-gray-600">{sub.team_count}명</span>
                    <Badge variant="outline" className="text-xs">
                      {currentStep}/{totalSteps} 단계
                    </Badge>
                  </div>
                  ...
                  <Button
                    ...
                    size="sm"
                    onClick={() => router.push(`/dashboard/experience/detail/${sub.id}`)}
                    className="w-full text-xs h-9 text-violet-600"
                  >
                    <Eye className="h-3 w-3 mr-1" />
                    상세보기
                  </Button>
