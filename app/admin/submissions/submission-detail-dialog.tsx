...
import { Copy, ExternalLink, Download, Image as ImageIcon, X, Package } from 'lucide-react';
import { useSubmissionDetail } from '@/hooks/admin/useSubmissionDetail';
import {
  STATUS_LABELS,
  STATUS_VARIANTS,
  TYPE_LABELS,
  type SubmissionDetailDialogProps,
} from '@/components/admin/submission-detail';
...
export function SubmissionDetailDialog({
  ...
  const {
    ...
    downloadAllFiles,
    formatDate,
  } = useSubmissionDetail(open, submissionId, submissionType);
