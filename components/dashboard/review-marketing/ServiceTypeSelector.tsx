...
import { ReviewType, ReviewServiceConfig } from '@/types/review-marketing/types';
  ...
  return (
    <Card className="border-gray-200">
      <CardHeader className="pb-3">
        <CardTitle className="text-gray-900 text-base">리뷰 서비스 선택</CardTitle>
        <CardDescription className="text-gray-600 text-sm">원하시는 리뷰 서비스를 선택하세요</CardDescription>
      </CardHeader>
