...
4. ⚠️ 글자수 엄수: 지정된 글자수 범위를 반드시 준수 (최대 글자수 절대 초과 금지!)
5. 반복적인 표현이나 문장 구조 피하기
6. 매장 정보가 제공된 경우, 메뉴명/가격/특징 등을 자연스럽게 언급
7. 짧은 글자수(30-80자, 80-150자)는 핵심만 간결하게 1-2문장으로 작성
...
2. 구체적인 경험과 감상을 담을 것
3. 홍보성 글이 아닌 진정성 있는 후기처럼 작성
4. ⚠️ 글자수 엄수: 각 리뷰의 지정된 글자수 범위를 반드시 준수 (최대 글자수 절대 초과 금지!)
...
11. 짧은 글자수(30-80자, 80-150자)는 핵심만 간결하게 1-2문장으로 작성
